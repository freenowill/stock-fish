...
from market_data.data_fetchers.base import BaseFetcher, STANDARD_COLUMNS
from market_data.data_fetchers.realtime_types import UnifiedRealtimeQuote, RealtimeSource, safe_float
...
def _longbridge_config_kwargs() -> Dict[str, Any]:
    ...
    if "language" in params:
        try:
            rl = os.getenv("REPORT_LANGUAGE", "zh").strip().lower()
            if rl == "zh":
